    ...
    <footer className={styles.footer}>
      <div className={styles.footer__wrapper}>
          ...
          <li>
            <a>
              <svg
                ...
                width="20"
                height="20"
                className={`${styles.logo} ${styles.logo__facebook}`}
              >
                <defs>
                  <linearGradient
                    id="facebook"
          ...
          <li>
            <a>
              <svg
                ...
                width="21"
                height="20"
                className={`${styles.logo} ${styles.logo__youtube}`}
              >
                <defs>
                  <linearGradient
                    id="youtube"
          ...
          <li>
            <a>
              <svg
                ...
                width="21"
                height="18"
                className={`${styles.logo} ${styles.logo__twitter}`}
              >
                <defs>
                  <linearGradient
                    id="twitter"
          ...
          <li>
            <a>
              <svg
                ...
                width="20"
                height="20"
                className={`${styles.logo} ${styles.logo__pinterest}`}
              >
                <defs>
                  <linearGradient
                    id="pinterest"
          ...
          <li>
            <a>
              <svg
                ...
                width="21"
                height="20"
                className={`${styles.logo} ${styles.logo__instagram}`}
              >
                <defs>
                  <linearGradient
                    id="instagram"
        ...
        <ul className={styles.footer__nav}>
          <li>
            <Link className="heading-xsmall">Home</Link>
          </li>
          <li>
            <Link className="heading-xsmall">Stories</Link>
          </li>
          <li>
            <Link className="heading-xsmall">Features</Link>
          </li>
          <li>
            <Link className="heading-xsmall">Pricing</Link>
          </li>
        </ul>
