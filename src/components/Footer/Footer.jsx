    ...
    <footer className={styles.footer}>
      <div className={styles.footer__wrapper}>
        ...
        <ul className={styles.footer__socials}>
          <li>
            <a href="https://www.facebook.com/">
              ...
              <LogoFacebook aria-hidden="true" focusable="false" />
            </a>
          </li>
          <li>
            <a href="https://www.youtube.com/">
              <span className="visually-hidden">Youtube</span>
              <LogoYoutube aria-hidden="true" focusable="false" />
            </a>
          </li>
          <li>
            <a href="https://www.twitter.com/">
              <span className="visually-hidden">Twitter</span>
              <LogoTwitter aria-hidden="true" focusable="false" />
            </a>
          </li>
          <li>
            <a href="https://www.pinterest.com/">
              <span className="visually-hidden">Pinterest</span>
              <LogoPinterest aria-hidden="true" focusable="false" />
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/">
              <span className="visually-hidden">Instagram</span>
              <LogoInstagram aria-hidden="true" focusable="false" />
            </a>
          </li>
        </ul>
        ...
        <ul className={styles.footer__nav}>
          <li>
            <Link className="heading-xsmall" to="/">
              Home
            </Link>
          </li>
          <li>
            <Link className="heading-xsmall" to="/stories">
              Stories
            </Link>
          </li>
          <li>
            <Link className="heading-xsmall" to="/features">
              Features
            </Link>
          </li>
          <li>
            <Link className="heading-xsmall" to="/pricing">
              Pricing
            </Link>
          </li>
        </ul>
...
function LogoInstagram({ ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="21"
      height="20"
      className={` ${styles.logo__instagram}`}
      {...rest}
    >
      <defs>
...
function LogoPinterest({ ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
      height="20"
      className={` ${styles.logo__pinterest}`}
      {...rest}
    >
      <defs>
...
function LogoFacebook({ ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
      height="20"
      className={`${styles.logo__facebook}`}
      {...rest}
    >
      <defs>
...
function LogoYoutube({ ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="21"
      height="20"
      className={`${styles.logo__youtube}`}
      {...rest}
    >
      <defs>
